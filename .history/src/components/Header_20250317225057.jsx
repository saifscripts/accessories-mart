                    ...
                    <div class="px-4 mx-auto sm:px-6 lg:px-8">
                        <nav class="relative flex items-center justify-between h-16 lg:h-20">
                            ...
                            <div class="hidden lg:flex lg:items-center lg:space-x-10">
                                ...
                                <Link to='/cart' class=" bg-gray-100 flex justify-center items-center mt-[-12px]">
                                    <div class="relative">
                ...
                <nav class="py-4 bg-white lg:hidden">
                    <div class="px-4 mx-auto sm:px-6 lg:px-8">
                        ...
                        <div class="mt-6">
                            ...
                            <div class="flex flex-col space-y-2">
                                <Link to="/login" title="" class="py-2 text-base font-medium text-black transition-all duration-200 focus:text-blue-600"> Sign up </Link>

                                <Link href="/register" title="" class="py-2 text-base font-medium text-black transition-all duration-200 focus:text-blue-600"> Sign in </Link>
                            </div>
                        </div>
                    </div>
                </nav>
