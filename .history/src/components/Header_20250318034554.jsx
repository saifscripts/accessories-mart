                    ...
                    <div class="px-4 mx-auto sm:px-6 lg:px-8">
                        <nav class="relative flex items-center justify-between h-16 lg:h-20">
                            ...
                            <div class="hidden lg:flex lg:items-center lg:space-x-10">
                                ...
                                {
                                    user?.user.uid ? <div class="relative">
                                     <div>
                                    ...
                                    </div> : <Link to="/login" title="" class="py-2 text-base font-medium text-black transition-all duration-200 focus:text-blue-600"> Sign in </Link>
                                }
