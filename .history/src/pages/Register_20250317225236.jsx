                            ...
                            <form action="#" method="POST">
                                <div class="space-y-5">
                                    ...
                                    <div class="text-center">
                                        <p class="text-base text-gray-600">Have an account? <a href="#" title="" class="font-medium text-orange-500 transition-all duration-200 hover:text-orange-600 hover:underline">Create a free account</a></p>
                                    </div>
                                </div>
                            </form>
                        </div>
